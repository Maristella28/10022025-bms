        ...
        <div class="content">
            ...
            <div class="resident-info">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $resident->sex ?? 'N/A' }}</span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $resident->years_in_barangay ?? 'N/A' }} years</span>
                </div>
                <div class="info-row">
            ...
            <div class="certificate-text">
                This certification is valid for 6 months from the date of issuance and may be used for various government and private transactions requiring proof of residency.
            </div>
